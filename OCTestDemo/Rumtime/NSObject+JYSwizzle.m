...
@implementation NSObject (JYSwizzle)
...
+ (BOOL)jy_swizzleClassMethod:(SEL)origSel_ withClassMethod:(SEL)altSel_ error:(NSError**)error_ {
    return [GetClass((id)self) jy_swizzleMethod:origSel_ withMethod:altSel_ error:error_];
}

+ (NSInvocation*)jy_swizzleMethod:(SEL)origSel withBlock:(id)block error:(NSError**)error {
    IMP blockIMP = imp_implementationWithBlock(block);
    NSString *blockSelectorString = [NSString stringWithFormat:@"_jy_block_%@_%p", NSStringFromSelector(origSel), block];
    ...
    [self jy_swizzleMethod:origSel withMethod:blockSel error:nil];
    
    return origInvocation;
}

+ (NSInvocation*)jy_swizzleClassMethod:(SEL)origSel withBlock:(id)block error:(NSError**)error {
    NSInvocation *invocation = [GetClass((id)self) jy_swizzleMethod:origSel withBlock:block error:error];
